...
# Parent: gen_037_random_regular_k4free (target degree sqrt(N)+3 instead of +1; denser start)
# Hypothesis: higher-degree RR start gives denser K4-free residual with better α/d_max ratio
# Why non-VT: random regular + K4 removal; higher degree makes degree-variation post-removal larger
