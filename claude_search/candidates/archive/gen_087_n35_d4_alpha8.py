...
# Parent: gen_055_targeted_n35 (d=4 target; 500 new seeds beyond gen_055's 0-499; exact IS)
# Hypothesis: seeds 500-4999 may find K4-free 4-regular N=35 with α=8 (c=0.660<0.6789)
...
def construct(N):
    ...
    for s in range(500, 3000):
        rng = random.Random(N * 41 + s)
        stubs = []
